<?php 
	class usuario
	{
		...
		{
			$sql = "SELECT id_usuario, nombre_usuario, apellido_usuario, email_usuario, username, level, id_colegio, id_circuito, telefono FROM usuarios WHERE nombre_usuario like '%".$valor."%' or apellido_usuario like '%".$valor."%' or email_usuario like '%".$valor."%' or username like '%".$valor."%' ORDER BY level ASC LIMIT ".$pag." OFFSET ".$cantidad."";
		...
		{
			$sql = "SELECT id_usuario, nombre_usuario, apellido_usuario, email_usuario, username, level, id_colegio, id_circuito, telefono FROM usuarios WHERE nombre_usuario like '%".$valor."%' or apellido_usuario like '%".$valor."%' or email_usuario like '%".$valor."%' or username like '%".$valor."%' ORDER BY level ASC";
			$this->conexion->conexion->set_charset('utf8');
			$resultados = $this->conexion->conexion->query($sql);
			$arreglo = array();
			$aux=0;
